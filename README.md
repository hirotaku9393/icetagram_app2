...
## 🍧サービス概要
～まだ味わったことのない、あなたにぴったりなアイスとの出会いをお届けするサービス～

「icetagram」はユーザーの味や好みにぴったりなアイスをおすすめしたり、まだ味わったことのないアイスとの出会いを提供するサービスです。
...
## 🍦開発動機
私はこれまでの仕事を通して潜在的な需要はあるけれど、具体的な購入やサービスを受けるに至るまで結びつかないという事を多く経験しもどかしさを感じてきました。こんなものが欲しい！こういうサービスを受けたい！というニーズがあったとしてもそもそもの購入・依頼方法が分からない、分かったとしても具体性に欠けていて購入まで至らない事を多々目にしてきました。
...
そんな私は夏に限らず冬でもアイスを食べるアイス好きです。人並み以上にはアイスを食べ、いろいろな種類を食べてきました。そこでユーザーがまだ口にしたことのないアイスと巡り合い、食べたい！と思うことで「潜在的な需要と供給を結びつける」事が出来るのではないかという思いから「icetagram」を制作しました。

 ## 🔎機能紹介
 ### あいす一覧
他のユーザーが投稿したアイスの一覧を見れます。名前によって検索する機能やタグに紐づいているアイスの一覧に遷移ができ、好みのアイスを探すことが出来ます。ログインをすることで自分の好みのアイスを投稿する機能や、一覧からお気に入りに登録する機能もあります。
